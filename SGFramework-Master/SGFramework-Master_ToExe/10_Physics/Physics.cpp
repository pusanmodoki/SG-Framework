/*----------------------------------------------------------------------------------
ï®óùÉGÉìÉWÉì(PhysX)Çä«óùÇ∑ÇÈPhysics class
------------------------------------------------------------------------------------*/
...
namespace SGFramework
{
	...
	//Default PhysicsMaterial (staticFriction = 0.5f, dynamicFriction = 0.5f, restitution(îΩî≠åWêî) = 0.1f)
	...
	//à¯êî1: gravity
	//à¯êî2: HitPair->Init Num Reserve
		...
		const ReadElement::Pack& hitPairVectorReserves)
	{
		...
		if (m_cudaManager != nullptr)
		{
			...
			sceneDesc.gpuMaxNumPartitions = 8;//2ÇÃÇ◊Ç´èÊÇæÇØÇ¡Ç€Ç¢
